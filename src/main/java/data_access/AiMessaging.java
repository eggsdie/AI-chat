...
public class AiMessaging {
    public static void main(String[] args) {
        final Cohere cohere = Cohere.builder()
        ...
        try {
            // Make the API call
            final ChatResponse rawResponse = cohere.v2().chat(
            ...
            final ChatResponse processedResponse = mapper.readValue(rawJson, ChatResponse.class);
